...
describe("Create", () => {
  ...
  describe("Users", () => {
    it("should have correct username", () =>
      expect(amina.username).toBe("amina"));
    it("should allow undefined email", () =>
      expect(amina.email).toBeUndefined());
    it("should have correct email", () =>
      expect(liam.email).toBe("liam.oconnor@example.com"));
    it("should assign sequential IDs", () => expect(sofia.id).toBe(3));
  });

  describe("Events", () => {
    it("should set correct host_id", () =>
      expect(potluck.host_id).toBe(amina.id));
    it("should parse date correctly", () =>
      expect(potluck.date.getMonth()).toBe(10));
    it("should allow undefined description", () =>
      expect(potluck.description).toBeUndefined());
    it("should have correct description", () =>
      expect(expo.description).toMatch(/^Discover/));
    it("should set correct host_id", () => expect(expo.host_id).toBe(sofia.id));
    it("should parse year correctly", () =>
      expect(expo.date.getFullYear()).toBe(2026));
  });
});
